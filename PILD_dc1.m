...
k0=1;
c=size(ntr,1);
fid=fopen('D:\2d_vow\inv_dc1\result\basicdata_train.txt','w');
...
%%/////////////////////////////////////////////////////////////////////////////////////////////
         ...
         fprintf(fid,'runtime(%d,%d)=%g\n',r,t,t1);
%/////////////////////////////////////////////////////////////////////////////////
         if (aver_index(2)>0.08)&(((ir>99)&(numtr_0(2)<=numtr_0(1)))|(ir<=99))
...
%%/////////////////////////////////////////////////////////////////////////////////////////////
         ...
         fprintf(fid,'runtime(%d,%d)=%g\n',r,t,t1);
%///////////////////////////////////////////////////////////////////////////////////
         if (aver_index(3)>0.08)&(((ir>99)&(numtr_0(3)<=numtr_0(2))&(numtr_0(2)<=numtr_0(1)))|(ir<=99))
...
fid=fopen('D:\2d_vow\inv_dc1\result\w0.txt','w');
    fprintf(fid,'%.8f %.8f\n',w2');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\theta0.txt','w');
    fprintf(fid,'%.8f\n',theta2');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\w.txt','w');
    fprintf(fid,'%.8f %.8f\n',w4');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\theta.txt','w');
    fprintf(fid,'%.8f\n',theta4');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\w1.txt','w');
    fprintf(fid,'%.8f %.8f\n',w6');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\theta1.txt','w');
    fprintf(fid,'%.8f\n',theta6');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\w2.txt','w');
    fprintf(fid,'%.8f %.8f\n',w8');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\theta2.txt','w');
    fprintf(fid,'%.8f\n',theta8');
fclose(fid);
fid=fopen('D:\2d_vow\inv_dc1\result\sign0.txt','w');
    fprintf(fid,'%g\n',sign0');
fclose(fid);
...
load D:\2d_vow\train.txt;
load D:\2d_vow\ntr.txt;
load D:\2d_vow\inv_dc1\result\w0.txt;
load D:\2d_vow\inv_dc1\result\w.txt;
load D:\2d_vow\inv_dc1\result\w1.txt;
load D:\2d_vow\inv_dc1\result\w2.txt;
load D:\2d_vow\inv_dc1\result\theta0.txt;
load D:\2d_vow\inv_dc1\result\theta.txt;
load D:\2d_vow\inv_dc1\result\theta1.txt;
load D:\2d_vow\inv_dc1\result\theta2.txt;
load D:\2d_vow\inv_dc1\result\sign0.txt;
...
err_train
fid=fopen('D:\2d_vow\inv_dc1\result\err_train.txt','w');
...
err_test
fid=fopen('D:\2d_vow\inv_dc1\result\err_test.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test');
fclose(fid);
...
fid=fopen('D:\2d_vow\inv_dc1\result\Number_error_train.txt','w');
    fprintf(fid,'\nFor the train set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\2d_vow\inv_dc1\result\Number_error_test.txt','w');
    fprintf(fid,'\nFor the test set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
